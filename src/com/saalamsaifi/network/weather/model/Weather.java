package com.saalamsaifi.network.weather.model;
...
public class Weather {
	...
	public String toString() {
		...
		if (dateTime != null)
			builder.append("date=").append(dateTime).append(", ");
		builder.append("temperature=").append(temperature).append(", minTemperature=").append(minTemperature)
				.append(", maxTemperature=").append(maxTemperature).append(", ");
		if (description != null)
